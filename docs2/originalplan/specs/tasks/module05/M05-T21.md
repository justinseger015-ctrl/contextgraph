...
All structs have been implemented in `crates/context-graph-utl/src/lib.rs`:

| Component | Location | Status |
|-----------|----------|--------|
| `LearningIntensity` enum | lib.rs:206 | ✅ IMPLEMENTED |
| `LearningSignal` struct | lib.rs:273 | ✅ IMPLEMENTED |
| `UtlState` struct | lib.rs:454 | ✅ IMPLEMENTED |
| `SuggestedAction` Serialize/Deserialize | johari/retrieval.rs:41 | ✅ FIXED |
...
# (Increased from 369 to 385 tests)
```

### New Tests Added

- `test_learning_signal_creation_valid`
- `test_learning_signal_validation_nan_magnitude`
- `test_learning_signal_validation_infinity_magnitude`
- `test_learning_signal_validation_nan_component`
- `test_learning_intensity_categories`
- `test_learning_intensity_boundary_values`
- `test_utl_state_from_signal`
- `test_utl_state_empty`
- `test_utl_state_default_matches_empty`
- `test_utl_state_staleness`
- `test_utl_state_validation_success`
- `test_utl_state_validation_nan`
- `test_utl_state_validation_infinity`
- `test_utl_state_serialization_roundtrip`
- `test_learning_signal_serialization_roundtrip`
- `test_learning_signal_with_lambda_weights`
